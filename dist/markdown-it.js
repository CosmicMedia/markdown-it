...
(function(global, factory) {
 ...
 // opening tag
  ...
  var linkify = function linkify(state, silent) {
    ...
    match = state.pending.match(SCHEME_RE$1);
 ...
 // opening tag
  ...
  ////////////////////////////////////////////////////////////////////////////////
  // Parser rules
    var _rules = [ [ "text", text ], [ "linkify", linkify ], [ "timestamp", clickable_timestamp ], [ "newline", newline ], [ "escape", _escape ], [ "backticks", backticks ], [ "strikethrough", strikethrough.tokenize ], [ "emphasis", emphasis.tokenize ], [ "link", link ], [ "image", image ], [ "autolink", autolink ], [ "html_inline", html_inline ], [ "entity", entity ] ];
